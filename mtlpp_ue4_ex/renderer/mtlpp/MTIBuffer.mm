...
//		fs << Range.length;
//		
//		MTITraceArray<uint8_t> Data;
//		Data.Data = (uint8_t*)[(id<MTLBuffer>)Object contents] + Range.location;
...
//		fs >> Data;
//		
//		memcpy(((uint8_t*)[(id<MTLBuffer>)MTITrace::Get().FetchObject(Header.Receiver) contents] + Range.location), Data.Backing.data(), Data.Length);
//		
